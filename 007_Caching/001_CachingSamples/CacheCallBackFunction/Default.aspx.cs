...
namespace CacheCallBackFunction
{
    public partial class Default : System.Web.UI.Page
    {
        protected void AddButton_Click(object sender, EventArgs e)
        {
            AddFileDataToCache("testfile.txt");
        }
        ...
        private void CreateAndCache(string buffer, string filePath)
        {
            ...
            // Этот метод будет срабатывать в том случае если запись будет удалена из кэша.
            // Возможные причины: 
        ...
        void ReloadFile(string key, object value, CacheItemRemovedReason reason)
        {
