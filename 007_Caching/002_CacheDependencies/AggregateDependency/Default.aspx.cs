...
namespace CacheDependencies
{
    public partial class Default : System.Web.UI.Page
    {
        protected void Button_Click(object sender, EventArgs e)
        {
            ...
            string filePath1 = Server.MapPath("file1.txt");
            string filePath2 = Server.MapPath("file2.txt");
            ...
            // Добавление элемента в кэш. Элемент будет удален в случае если файл file1.txt или file2.txt будут изменены.
