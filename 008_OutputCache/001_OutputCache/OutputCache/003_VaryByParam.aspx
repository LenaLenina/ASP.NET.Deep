<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="003_VaryByParam.aspx.cs" Inherits="OutputCache._003_VaryByParam" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <%--
                Выпадающий список будет отправлять на сервер значение каждый раз при смене выбранного пункта.
